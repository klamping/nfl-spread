...
# Load the dataset
file_path = "../model-data/seasons-again-versus.csv"  # Update to your dataset path
data = pd.read_csv(file_path)

# Load correlation data from CSV
correlation_file_path = "../Cleaned_Correlation_Data.csv"
...
for fold, (train_index, val_index) in enumerate(kf.split(X)):
    ...
    weight_adjustment_factor = 0.7  # Reduce emphasis by 50%
...
model.save("final_model_with_kfold.keras")
print("Final model saved as 'final_model_with_kfold.keras'")

# Save the scaler
scaler_filename = "scaler_with_kfold.pkl"
